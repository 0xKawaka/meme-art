...
// Generated by dojo-bindgen on Thu, 3 Oct 2024 15:01:37 +0000. Do not modify this file manually.
...
export async function setupWorld(provider: DojoProvider) {
    ...
    function MemeArt() {
        ...
        const createDrawing = async (props: { account: Account, name: bigint, symbol: bigint }) => {
            try {
        ...
        // Call the `setSelfAdrs` system with the specified Account and calldata
        const setSelfAdrs = async (props: { account: Account, selfAdrs: bigint }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
                        contractName: contract_name,
                        entrypoint: "setSelfAdrs",
                        calldata: [props.selfAdrs],
                    },
                    "memeart"
                );
            } catch (error) {
        ...
        return {
            createDrawing, colorPixels, setOwner, setPixelsRowCount, setPixelsColumnCount, setRaiseTarget, setQuoteCurrency, setTokenHash, setTokenTotalSupply, setSelfAdrs, world
        };
    }
